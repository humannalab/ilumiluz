        ...
        <div style={{
          ...
          {steps.map(s => (
            <div key={s.n} style={{
              ...
              <p style={{ fontSize: 12.5, lineHeight: 1.75, color: 'var(--il-muted)', margin: 0 }}>
                {s.body}
              </p>
            </div>
          ))}
